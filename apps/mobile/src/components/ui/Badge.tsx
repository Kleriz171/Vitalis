...
type BadgeProps = React.ComponentProps<"span"> &
  VariantProps<typeof badgeVariants> & {
    asChild?: boolean
    /** Legacy: pre-shadcn color hint (cyan/pink/emerald/violet/amber/slate). Ignored; removed after Phase 4. */
    tone?: string
  }
...
// Legacy: pre-shadcn StatusBadge took a `status` string. Map to badge variants. Removed after Phase 4.
